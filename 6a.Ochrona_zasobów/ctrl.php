...
switch ($action) {
	default :
		control('app\\controllers', 'CalcCtrl',		'generateView', ['employee','manager']);
	case 'login': 
	...
	case 'calcCompute' : 
		...
		control(null, 'CalcCtrl',	'process',		['employee','manager']);
	case 'logout' : 
		control(null, 'LoginCtrl',	'doLogout',		['employee','manager']);
}
